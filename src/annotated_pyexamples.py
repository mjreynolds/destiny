...
uniqueName = '22111524'
displayName = 'Valar Morghulis'
steamDisplayName = 'Valar.Morghulis'
...
def search_user_url(search_string):
    """Search users using a search string
       https://bungie-net.github.io/multi/operation_get_Destiny2-SearchDestinyPlayer.html
    """
    return baseurl2 + 'User/SearchUsers/?q=' + search_string
...
if __name__ == '__main__':
    ...
    #search_results = destiny2_api_public(search_user_url, my_api_key)
